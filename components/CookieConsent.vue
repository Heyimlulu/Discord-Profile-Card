<template>
  <ClientOnly>
    ...
    >
      <div
        v-if="showConsent"
        class="fixed bottom-4 left-4 right-4 md:left-8 md:right-auto md:max-w-md bg-[#2f3136] rounded-lg shadow-xl border border-[#1e1f22] z-50"
      >
        <div class="p-4 md:p-6">
          <div class="mb-4">
            ...
            <p class="text-[#b5bac1] text-sm leading-relaxed">
              This website uses cookies to improve your experience. Please
